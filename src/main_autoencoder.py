...
from lateral_connections.feature_extractor.ae_pl_modules import AEFeatureExtractor
...
def get_model(config: Dict[str, Optional[Any]], fabric: Fabric) -> BaseLitModule:
    ...
    :return: The model
    """
    return AEFeatureExtractor(config, fabric)
    ...
    with torch.no_grad():
        for i, batch in tqdm(enumerate(test_dataloader),
            ...
            if config['run']['visualize_plots'] and i == 0:
                ...
                model.visualize_filters(batch, i)
