...
def load_data_generator() -> Iterator[Tuple[Tensor, List[Dict[str, Any]]]]:
    ...
    dataset = torch.utils.data.Subset(
        MNIST(root='../data/mnist', transform=transform), [1, 2, 4, 8, 9, 11, 13, 14, 16, 17, 18, 19, 22, 26, 30, 31, 32, 33, 35, 36, 38, 39, 40, 41, 42, 43, 45, 46, 47, 54, 57, 61, 64, 66, 68, 72, 73, 80, 83, 84, 86, 87, 92, 96, 99, 100, 101, 102, 103, 106, 108, 115, 118, 123, 124, 125, 127, 131, 132, 133, 136, 139, 140, 141, 142, 143, 144, 145, 148, 150, 151, 152, 153, 154, 155, 156, 158, 160, 162, 170, 174, 176, 178, 183, 186, 188, 191, 195, 196 ])
...
def process_data(
    ...
    """
    fps = 1
    frames_last = 0  # int(fps // 2)  # show the median activation for a longer time...
    ci = CustomImage()
